...
This project aims to explore the factors that lead to loan default and use 
machine learning models to predict the chance of an applicant defaulting on their
loan in the future. The Bank has experienced customers defaulting on their loans 
and therefore seeks to predict whether an applicant will default on their loan
in order to protect the Bank from large financial losses.
...
whether an applicant will default or not. This variable has also been coded with 
'Yes' and 'No' factors. Therefore using visualization techniques this report will 
showwhich other factors can explain why some applicants default and others do not.
